...
app.controller("ctrlPrincipal",function($scope, $http, $compile, $mdSidenav, $mdDialog)
    {
        ...
        $scope.seccion="Asesores Activos";
        ...
        $scope.$watch('form.P_EMPRESA', function($new,$old)
        {
...
//                            $scope.enviar_notificacion("Notificaciones Denegadas!");
        ...
        {
            if($scope.form.P_EMPRESA=="") return false;
            return true;
        }
                ...
                .then(function($response)
                    {
                        ...
                        if(!$response.data.ERROR)
                        {
                            ...
                            $scope.grid.informacion.datos_x_estado=$response.data.datos.datos_x_estado;
        ...
        $scope.exportar_pdf = function()
        {
            ...
            formData.append("form",JSON.stringify($scope.form));
            formData.append("data",JSON.stringify($scope.grid.informacion));
            formData.append("datos_x_estado",JSON.stringify($scope.grid.informacion.datos_x_estado));
